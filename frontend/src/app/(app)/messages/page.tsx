...
interface Entry { id: string; content: string; media_type: string; sender_name: string; sent_at: string; from_me: boolean; transcript?: string | null }
